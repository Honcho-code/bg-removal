  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500'>Say goodbye to complicated editing tools—our AI-powered <br className='max-sm:hidden'/>background remover makes it easy to isolate subjects with just one click.</p>
            <div>
        ...
        {/* right side */}
        <div>
          <img src={assets.header_img} alt="header-image" className='w-full max-w-md'/>
        </div>
    </div>
  )
}
