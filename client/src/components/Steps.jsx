        ...
        <div className='flex items-start flex-wrap gap-6 mt-16 xl:mt-24 justify-center'>
            <div className='flex items-start gap-4 bg-white border-gray-500 drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Simply upload your image in either jpeg,<br />jpg or gif format.</p>
                </div>
            </div>
            <div className='flex items-start gap-4 bg-white border-gray-500 drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'> Allow our AI remove the background <br />of your image in seconds.</p>
                </div>
            </div>
            <div className='flex items-start gap-4 bg-white border-gray-500 drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Download your image in png formart<br />without any background.</p>
                </div>
            </div>
        </div>
    </div>
